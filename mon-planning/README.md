<p align="center">
  <img src="Logo_VaryaCode.png" alt="VaryaCode Logo" width="180"/>
</p>

<h1 align="center">Planning Hebdomadaire Interactif</h1>

<p align="center">
  Une application web moderne pour organiser sa semaine — développée par <strong>VaryaCode</strong>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/License-Propriétaire%20VaryaCode-1a1a2e?style=flat-square"/>
</p>
...
- Nettoyage rapide des tâches terminées en un clic
...
│   └── Logo_VaryaCode.png
├── src/
│   ├── App.jsx          # Composant principal — logique et UI
...
- [ ] Navigation entre plusieurs semaines
- [ ] Mode clair / sombre
...
Ce projet est né d'un besoin personnel : retranscrire un planning papier hebdomadaire en outil numérique simple, visuel et modifiable. Il a été développé de manière itérative en partant d'une photo du planning manuscrit, dans le cadre du lancement de **VaryaCode**.
...
```
Copyright © 2026 VaryaCode — Web Development
Tous droits réservés.

Ce logiciel et son code source sont la propriété exclusive de VaryaCode.
Toute reproduction, distribution, modification ou utilisation commerciale,
partielle ou totale, sans autorisation écrite préalable de VaryaCode,
est strictement interdite.

Pour toute demande de licence ou d'utilisation :
contact@varyacode.fr
```

---

<p align="center">
  Développé avec ❤️ par <strong>VaryaCode — Web Development</strong>
</p>
